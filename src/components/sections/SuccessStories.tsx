    ...
    return (
        <section className="pt-0 pb-24 md:pb-32 bg-black relative overflow-hidden" id="success-stories">
            ...
            <div className="container mx-auto px-2 md:px-6 relative z-10">
                {/* Header */}
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 md:gap-12 mb-16 md:mb-20 px-2 md:px-0">
                ...
                <div className="relative overflow-x-auto md:overflow-hidden snap-x snap-mandatory no-scrollbar -mx-2 px-2 md:mx-0 md:px-0 pb-8 md:pb-0">
                    <motion.div
